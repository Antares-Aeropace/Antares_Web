    ...
    return (
        <>
            <header className="header-AA">
                ...
                <div className="gradient-AA"></div>
            </header>

            <main className="container">

                <section className="objetivos-clave">
                    <h1>Objetivos Clave</h1>
                    <hr />
...
export default AntaresAerospace